...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post manufacturers_url, params: { manufacturer: { adress: @manufacturer.adress, email: @manufacturer.email, name: @manufacturer.name, phone: @manufacturer.phone } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { adress: @manufacturer.adress, email: @manufacturer.email, name: @manufacturer.name, phone: @manufacturer.phone } }
