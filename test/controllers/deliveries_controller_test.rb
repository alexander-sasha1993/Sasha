...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { name: @delivery.name, phone: @delivery.phone } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { name: @delivery.name, phone: @delivery.phone } }
